    ...
    <Box sx={{ overflowX: 'hidden' }}>
      ...
      <Box sx={{ 
        ...
        <Box sx={{
          ...
          bottom: 0,
          opacity: 0.1,
          backgroundImage: 'radial-gradient(circle at 20% 150%, white 0%, transparent 50%)',
        }} />

        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Grid container spacing={8} alignItems="center">
            <Grid item xs={12} md={6}>
              <Typography variant="h2" gutterBottom fontWeight="bold" sx={{ color: 'white' }}>
                Ready to file smarter?
              </Typography>
              <Typography variant="h6" sx={{ mb: 4, opacity: 0.9, fontWeight: 400 }}>
                Join thousands of satisfied clients who trust Affinity Tax Services for their financial success.
              </Typography>
                ...
                {[
                  ...
                  <Grid item xs={6} key={index}>
                    <Box sx={{ 
                      ...
                      <Typography variant="h3" fontWeight="800" sx={{ mb: 1, color: 'white', textShadow: '0 2px 10px rgba(0,0,0,0.2)' }}>
                        {stat.prefix}<CountUp end={stat.value} duration={2.5} />{stat.suffix}
                      </Typography>
                      <Typography variant="body1" fontWeight="600" sx={{ color: '#FFD700', letterSpacing: 0.5 }}>
                        {stat.label}
                      </Typography>
                    </Box>
                  </Grid>
